...
## [9.3.0](https://github.com/adria0/revm/compare/revm-precompile-v9.2.0...revm-precompile-v9.3.0) - 2024-08-08

### Added
- use batch bn256 pair operation ([#1643](https://github.com/adria0/revm/pull/1643))

### Other
- Add OP-Granite hardfork, limiting bn256Pairing input size ([#1685](https://github.com/adria0/revm/pull/1685))
- *(deps)* bump rstest from 0.21.0 to 0.22.0 ([#1681](https://github.com/adria0/revm/pull/1681))
- *(deps)* bump blst from 0.3.12 to 0.3.13 ([#1669](https://github.com/adria0/revm/pull/1669))
