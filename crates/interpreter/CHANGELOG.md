...
## [9.0.0](https://github.com/adria0/revm/compare/revm-interpreter-v8.1.0...revm-interpreter-v9.0.0) - 2024-08-08
...
- *(EOF)* implement std::error::Error trait for EofValidationError and EofError ([#1649](https://github.com/adria0/revm/pull/1649))
- *(interpreter)* derive traits on FunctionStack ([#1640](https://github.com/adria0/revm/pull/1640))

### Fixed
- add DATACOPY to OpCode::modifies_memory ([#1639](https://github.com/adria0/revm/pull/1639))
- *(EOF)* returning to non-returning jumpf, enable valition error ([#1664](https://github.com/adria0/revm/pull/1664))
- *(EOF)* Validate code access in stack ([#1659](https://github.com/adria0/revm/pull/1659))
- *(eof)* deny static context in EOFCREATE ([#1644](https://github.com/adria0/revm/pull/1644))

### Other
- improve `InstructionResult` documentation ([#1673](https://github.com/adria0/revm/pull/1673))
- Add EOF Layout Fuzz Loop to `revme bytecode` ([#1677](https://github.com/adria0/revm/pull/1677))
- *(eof)* Add opcodes that expand memory ([#1665](https://github.com/adria0/revm/pull/1665))
- *(clippy)* 1.80 rust clippy list paragraph ident ([#1661](https://github.com/adria0/revm/pull/1661))
- avoid cloning original_bytes ([#1646](https://github.com/adria0/revm/pull/1646))
