...
## [0.9.0](https://github.com/adria0/revm/compare/revme-v0.8.0...revme-v0.9.0) - 2024-08-08

### Added
- *(EOF)* Add EOF validation in revme bytecode cmd ([#1660](https://github.com/adria0/revm/pull/1660))
- *(EOF)* EOF Validation add code type and sub container tracker ([#1648](https://github.com/adria0/revm/pull/1648))

### Fixed
- *(statetest)* make bytecode analyzed ([#1666](https://github.com/adria0/revm/pull/1666))
- *(EOF)* returning to non-returning jumpf, enable valition error ([#1664](https://github.com/adria0/revm/pull/1664))
- *(statetest)* Add back Merge spec ([#1658](https://github.com/adria0/revm/pull/1658))
